...
// Skill structure is used to implement strength limit. If we have a USI_Elo,
...
struct Skill {
    ...
    Skill(int skill_level, int USI_Elo) {
        if (USI_Elo)
        {
            double e = double(USI_Elo - LowestElo) / (HighestElo - LowestElo);
