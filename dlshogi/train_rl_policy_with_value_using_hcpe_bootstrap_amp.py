...
optimizer = SWA(base_optimizer, swa_start=args.swa_freq, swa_freq=args.swa_freq, swa_lr=0.05, swa_n_avr=args.swa_n_avr)
...
# Interval Output
        if t % (eval_interval*5) == 0:
            print('save the model')
            serializers.save_npz(args.model+"_tmp", model)
