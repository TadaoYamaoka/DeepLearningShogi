...
class PolicyValueNetwork(nn.Module):
    def __init__(self, blocks, channels, activation=nn.ReLU(), fcl=256):
        ...
        self.mha = nn.TransformerEncoderLayer(32, 8, 256, batch_first=True, activation='gelu', dropout=0)
    ...
    def forward(self, x1, x2):
        ...
        h_policy = self.mha(h_policy.view(-1, 32, 81).transpose(1, 2)).transpose(1, 2).view(-1, 32, 9, 9)
