...
def hcpe_decode_with_value(np.ndarray ndhcpe, np.ndarray ndbags, np.ndarray ndmove, np.ndarray ndresult, np.ndarray ndvalue):
	__hcpe_decode_with_value(len(ndhcpe), ndhcpe.data, ndbags.data, ndmove.data, ndresult.data, ndvalue.data)

def hcpe2_decode_with_value(np.ndarray ndhcpe2, np.ndarray ndbags, np.ndarray ndmove, np.ndarray ndresult, np.ndarray ndvalue, np.ndarray ndaux):
	__hcpe2_decode_with_value(len(ndhcpe2), ndhcpe2.data, ndbags.data, ndmove.data, ndresult.data, ndvalue.data, ndaux.data)
...
def hcpe3_decode_with_value(np.ndarray ndindex, np.ndarray ndbags, np.ndarray ndprobability, np.ndarray ndresult, np.ndarray ndvalue):
	__hcpe3_decode_with_value(len(ndindex), ndindex.data, ndbags.data, ndprobability.data, ndresult.data, ndvalue.data)
