...
const int PIECETYPE_NUM = 14; // ãÓÇÃéÌóﬁ
const int MAX_ATTACK_NUM = 3; // óòÇ´êîÇÃç≈ëÂíl
const int PAWN_RANK_NUM = 1; // ï‡ÇÃÇ†ÇÈãÿ
const u32 MAX_FEATURES1_NUM = PIECETYPE_NUM/*ãÓÇÃîzíu*/ + PIECETYPE_NUM/*ãÓÇÃóòÇ´*/ + MAX_ATTACK_NUM/*óòÇ´êî*/ + PAWN_RANK_NUM/*ï‡ÇÃÇ†ÇÈãÿ*/;
