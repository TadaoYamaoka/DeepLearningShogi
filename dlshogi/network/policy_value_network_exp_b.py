...
class InceptionBlock(nn.Module):
    def __init__(self, channels, activation):
        ...
        self.conv1_1 = nn.Conv2d(channels, channels, kernel_size=(9, 1), groups=channels ,bias=False)
        self.conv1_2 = nn.Conv2d(channels, channels, kernel_size=(1, 9), groups=channels, bias=False)
        self.bn1 = nn.BatchNorm2d(channels)
        self.conv2 = nn.Conv2d(channels, channels * 4, kernel_size=1, bias=False)
