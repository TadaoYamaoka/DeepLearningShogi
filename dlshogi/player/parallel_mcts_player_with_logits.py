...
class ParallelMCTSPlayer(BasePlayer):
    def __init__(self):
        super().__init__()
        # モデルファイルのパス
        self.modelfile = os.path.join(os.path.dirname(__file__), '../../model/model_policy_value_resnet_with_logits-best.hdf5')
        self.model = None # モデル
    ...
    def usi(self):
        print('id name parallel_mcts_player_with_logits')
