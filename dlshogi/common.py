...
MAX_NYUGYOKU_OPP_FIELD = 10 # 敵陣三段目以内の駒(10枚までの残り枚数)
MAX_NYUGYOKU_SCORE = 10 # 点数(先手28点、後手27点までの残り枚数)
MAX_FEATURES2_NYUGYOKU_NUM = 1 + MAX_NYUGYOKU_OPP_FIELD + MAX_NYUGYOKU_SCORE
