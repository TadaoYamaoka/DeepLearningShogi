...
def hcpe_decode_lite(np.ndarray ndhcpe, np.ndarray ndfeatures1, np.ndarray ndfeatures2, np.ndarray ndresult, np.ndarray ndvalue):
    __hcpe_decode_lite(len(ndhcpe), ndhcpe.data, ndfeatures1.data, ndfeatures2.data, ndresult.data, ndvalue.data)
...
def hcpe3_decode_lite(np.ndarray ndindex, np.ndarray ndfeatures1, np.ndarray ndfeatures2, np.ndarray ndresult, np.ndarray ndvalue):
    __hcpe3_decode_lite(len(ndindex), ndindex.data, ndfeatures1.data, ndfeatures2.data, ndresult.data, ndvalue.data)
