...
checkpoint_path = args.model + "/model_value-best.hdf5"
...
model_path = args.model + "/model_value-final.hdf5"
model.save_weights(model_path, save_format="h5")

if not args.use_tpu:
    model.save(args.model + "/model_value.h5")
    with open(args.model + "/model_value.json", "w") as fjson:
