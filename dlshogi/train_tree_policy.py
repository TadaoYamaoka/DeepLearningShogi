...
parser.add_argument('--batchsize', '-b', type=int, default=4096, help='Number of positions in each mini-batch')
parser.add_argument('--testbatchsize', type=int, default=640, help='Number of positions in each test mini-batch')
parser.add_argument('--epoch', '-e', type=int, default=3, help='Number of epoch times')
...
parser.add_argument('--step_size', type=int, default=5000, help='period of learning rate decay')
