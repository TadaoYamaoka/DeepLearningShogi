...
NNFusedWideResnet10::NNFusedWideResnet10(const char* filename, const int max_batch_size) : max_batch_size(max_batch_size)
{
...
NNFusedWideResnet10::~NNFusedWideResnet10() {
...
void NNFusedWideResnet10::prepare_desc(const int batch_size)
{
...
void NNFusedWideResnet10::load_model(const char* filepath)
{
	// load nn params
	ParamMap params;
	...
	bias2.set_bias(params["l2/b.npy"].data);
	...
	bias6.set_bias(params["l6/b.npy"].data);
	...
	bias8.set_bias(params["l8/b.npy"].data);
	...
	bias10.set_bias(params["l10/b.npy"].data);
	...
	bias12.set_bias(params["l12/b.npy"].data);
	...
	bias14.set_bias(params["l14/b.npy"].data);
	...
	bias16.set_bias(params["l16/b.npy"].data);
	...
	bias18.set_bias(params["l18/b.npy"].data);
	...
	bias20.set_bias(params["l20/b.npy"].data);
...
void NNFusedWideResnet10::forward(const int batch_size, features1_t* x1, features2_t* x2, DType* y1, DType* y2)
{
	...
	conv3(cudnnHandle, h1Desc, h2_dev, h1Desc, h3_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv5(cudnnHandle, h1Desc, h2_dev, h1Desc, h5_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv7(cudnnHandle, h1Desc, h2_dev, h1Desc, h7_dev);
	...
	bias8(cudnnHandle, h1Desc, h2_dev);
	relu(cudnnHandle, h1Desc, h2_dev);
	conv9(cudnnHandle, h1Desc, h2_dev, h1Desc, h9_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv11(cudnnHandle, h1Desc, h2_dev, h1Desc, h11_dev);
	...
	bias12(cudnnHandle, h1Desc, h2_dev);
	relu(cudnnHandle, h1Desc, h2_dev);
	conv13(cudnnHandle, h1Desc, h2_dev, h1Desc, h13_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv15(cudnnHandle, h1Desc, h2_dev, h1Desc, h15_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv17(cudnnHandle, h1Desc, h2_dev, h1Desc, h17_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv19(cudnnHandle, h1Desc, h2_dev, h1Desc, h19_dev);
	...
	relu(cudnnHandle, h1Desc, h2_dev);
	conv21(cudnnHandle, h1Desc, h2_dev, h1Desc, h21_dev);
