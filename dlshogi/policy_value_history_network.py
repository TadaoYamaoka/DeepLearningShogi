...
class PolicyValueHistoryNetwork(Chain):
    def __init__(self):
        super(PolicyValueHistoryNetwork, self).__init__(
            l1_1_1=L.Convolution2D(in_channels = FEATURES1_HIST_NUM, out_channels = k, ksize = 3, pad = 1, nobias = True),
            l1_1_2=L.Convolution2D(in_channels = FEATURES1_HIST_NUM, out_channels = k, ksize = 1, pad = 0, nobias = True),
            l1_2=L.Convolution2D(in_channels = FEATURES2_HIST_NUM, out_channels = k, ksize = 1, nobias = True), # pieces_in_hand
