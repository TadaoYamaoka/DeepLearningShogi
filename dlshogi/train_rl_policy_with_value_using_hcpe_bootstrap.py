...
parser.add_argument('--network', type=str, default='wideresnet10', choices=['wideresnet10', 'wideresnet15', 'senet10', 'wideresnet10_swish', 'normal_resnet10_swish', 'normal_resnet20_256_swish'], help='network type')
...
elif args.network == 'wideresnet10_swish':
    from dlshogi.policy_value_network_swish import *
