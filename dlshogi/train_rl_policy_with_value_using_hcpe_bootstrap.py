...
parser.add_argument('--network', type=str, default='wideresnet10', choices=['wideresnet10', 'wideresnet15', 'senet10', 'resnet10_swish', 'resnet20_swish', 'resnet10_fixup', 'resnet10_fixup2', 'resnet10_nofixup'], help='network type')
...
if args.network == 'wideresnet15':
    ...
    model = PolicyValueNetwork()
elif args.network == 'resnet10_fixup':
    from dlshogi.policy_value_network_resnet_fixup import *
    model = PolicyValueNetwork(blocks=10, filters=192, units=256)
elif args.network == 'resnet10_fixup2':
    from dlshogi.policy_value_network_resnet_fixup2 import *
    model = PolicyValueNetwork(blocks=10, filters=192, units=256)
elif args.network == 'resnet10_nofixup':
    from dlshogi.policy_value_network_resnet_nofixup import *
    model = PolicyValueNetwork(blocks=10, filters=192, units=256)
else:
