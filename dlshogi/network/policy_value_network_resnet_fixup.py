...
class PolicyValueNetwork(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        x = self.act(u1_1_1 + u1_1_2 + u1_2 + self.bias1)
        ...
        # value network
        h_v = self.act(self.value_conv1(x))
        h_v = self.act(self.value_fc1(h_v.view(-1, 9*9*MAX_MOVE_LABEL_NUM)))
