...
class AttentionBlock(nn.Module):
    def __init__(self, d_model, nhead, activation):
        ...
        self.conv2 = nn.Conv2d(d_model * 4, d_model * 4, kernel_size=3, padding=1, groups=d_model * 4, bias=False)
        self.bn2 = nn.BatchNorm2d(d_model * 4)
        self.conv3 = nn.Conv2d(d_model * 4, d_model, kernel_size=1, bias=False)
