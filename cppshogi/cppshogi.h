...
const int CHECKINFO_NUM = 2; // â§éËèÓïÒ
const u32 MAX_FEATURES1_NUM = PIECETYPE_NUM/*ãÓÇÃîzíu*/ + PIECETYPE_NUM/*ãÓÇÃóòÇ´*/ + MAX_ATTACK_NUM/*óòÇ´êî*/ + CHECKINFO_NUM/*â§éËèÓïÒ*/;
