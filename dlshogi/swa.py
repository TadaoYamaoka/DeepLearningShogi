...
class SWA(Optimizer):
    def __init__(self, optimizer, swa_start=None, swa_freq=None, swa_lr=None, swa_n_avr=10):
    ...
    def update_swa_group(self, group):
        ...
        for p in group['params']:
            ...
            virtual_decay = 1 / float(self.n_avg + 1)
    ...
    def bn_update(loader, model):
        ...
        Args:
            loader (generator): dataset loader to compute the
